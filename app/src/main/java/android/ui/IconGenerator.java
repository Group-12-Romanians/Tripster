...
import static tripster.tripster.R.style.amu_Bubble_TextAppearance_Dark;
import static tripster.tripster.R.style.amu_Bubble_TextAppearance_Light;
...
public class IconGenerator {
     ...
     * #setTextAppearance} and {@link #(String)} will operate upon that {@link TextView}.
     */
    ...
    private static int getTextStyle(int style) {
        switch (style) {
            ...
            case STYLE_DEFAULT:
            case STYLE_WHITE:
                return amu_Bubble_TextAppearance_Dark;
            case STYLE_RED:
            case STYLE_BLUE:
            case STYLE_GREEN:
            case STYLE_PURPLE:
            case STYLE_ORANGE:
                return amu_Bubble_TextAppearance_Light;
        }
    }
}
