...
import android.geojson.GeoJsonFeature;
import android.geojson.GeoJsonGeometry;
import android.geojson.GeoJsonLineString;
import android.geojson.GeoJsonLineStringStyle;
import android.geojson.GeoJsonMultiLineString;
import android.geojson.GeoJsonMultiPolygon;
import android.geojson.GeoJsonPointStyle;
import android.geojson.GeoJsonPolygon;
...
/* package */ class GeoJsonRenderer implements Observer {
    ...
    private final android.geojson.GeoJsonPointStyle mDefaultPointStyle;
    ...
    /* package */ GeoJsonRenderer(GoogleMap map, HashMap<GeoJsonFeature, Object> features) {
        ...
        mLayerOnMap = false;
        mDefaultPointStyle = new android.geojson.GeoJsonPointStyle();
     ...
     */
    /* package */ android.geojson.GeoJsonPointStyle getDefaultPointStyle() {
     ...
     */
    private Marker addPointToMap(android.geojson.GeoJsonPointStyle pointStyle, GeoJsonPoint point) {
