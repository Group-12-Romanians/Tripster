 ...
 */
public class GeoJsonGeometryCollection implements android.geojson.GeoJsonGeometry {

    private final static String GEOMETRY_TYPE = "GeometryCollection";

    private final List<android.geojson.GeoJsonGeometry> mGeometries;
    ...
    public GeoJsonGeometryCollection(
            List<android.geojson.GeoJsonGeometry> geometries) {
        if (geometries == null) {
