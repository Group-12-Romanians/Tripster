...
public class GeoJsonFeature extends Observable implements Observer {
    ...
    private android.geojson.GeoJsonPointStyle mPointStyle;
     ...
     */
    public android.geojson.GeoJsonPointStyle getPointStyle() {
        return mPointStyle;
    }
     ...
     */
    private void checkRedrawFeature(android.geojson.GeoJsonStyle style) {
    ...
    public void update(Observable observable, Object data) {
        if (observable instanceof android.geojson.GeoJsonStyle) {
            checkRedrawFeature((android.geojson.GeoJsonStyle) observable);
        }
    }
}
