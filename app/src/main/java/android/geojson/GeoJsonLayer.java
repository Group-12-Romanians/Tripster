...
public class GeoJsonLayer {
    ...
    private final android.geojson.GeoJsonRenderer mRenderer;
    ...
    public GeoJsonLayer(GoogleMap map, JSONObject geoJsonFile) {
        ...
        mBoundingBox = null;
        android.geojson.GeoJsonParser parser = new android.geojson.GeoJsonParser(geoJsonFile);
        ...
        mRenderer = new android.geojson.GeoJsonRenderer(map, geoJsonFeatures);
    }
