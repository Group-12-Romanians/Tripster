...
package android.quadtree;

import android.geometry.Bounds;
 ...
 */
public class PointQuadTree<T extends android.quadtree.PointQuadTree.Item> {
     ...
     * Child quads.
     */
    private List<android.quadtree.PointQuadTree<T>> mChildren = null;
     ...
     */
    private void split() {
        mChildren = new ArrayList<android.quadtree.PointQuadTree<T>>(4);
        mChildren.add(new android.quadtree.PointQuadTree<T>(mBounds.minX, mBounds.midX, mBounds.minY, mBounds.midY, mDepth + 1));
        mChildren.add(new android.quadtree.PointQuadTree<T>(mBounds.midX, mBounds.maxX, mBounds.minY, mBounds.midY, mDepth + 1));
        mChildren.add(new android.quadtree.PointQuadTree<T>(mBounds.minX, mBounds.midX, mBounds.midY, mBounds.maxY, mDepth + 1));
        mChildren.add(new android.quadtree.PointQuadTree<T>(mBounds.midX, mBounds.maxX, mBounds.midY, mBounds.maxY, mDepth + 1));
    ...
    private void search(Bounds searchBounds, Collection<T> results) {
        ...
        if (this.mChildren != null) {
            for (android.quadtree.PointQuadTree<T> quad : mChildren) {
