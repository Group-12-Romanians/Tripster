...
import android.kml.KmlLineString;
import android.kml.KmlMultiGeometry;
import android.kml.KmlPolygon;
        ...
        while (!(eventType == END_TAG && parser.getName().equals("Placemark"))) {
            if (eventType == START_TAG) {
                if (parser.getName().equals(STYLE_URL_TAG)) {
                    ...
                    inlineStyle = android.kml.KmlStyleParser.createStyle(parser);
                }
            }
