...
import android.kml.KmlGroundOverlay;
import android.kml.KmlPlacemark;
...
public class KmlContainer {
    ...
    private final HashMap<android.kml.KmlPlacemark, Object> mPlacemarks;

    private final ArrayList<android.kml.KmlContainer> mContainers;
    ...
    /*package*/ KmlContainer(HashMap<String, String> properties, HashMap<String, KmlStyle> styles,
                             HashMap<android.kml.KmlPlacemark, Object> placemarks, HashMap<String, String> styleMaps,
                             ArrayList<android.kml.KmlContainer> containers, HashMap<KmlGroundOverlay, GroundOverlay>
     ...
     *                   to the map)
     */
    /* package */ void setPlacemark(android.kml.KmlPlacemark placemarks, Object object) {
     ...
     */
    /*package*/ HashMap<android.kml.KmlPlacemark, Object> getPlacemarksHashMap() {
        return mPlacemarks;
    }
     ...
     */
    public Iterable<android.kml.KmlContainer> getContainers() {
        return mContainers;
    }
