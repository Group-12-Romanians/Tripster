...
package android.clustering.algo;
 ...
 */
public class PreCachingAlgorithmDecorator<T extends ClusterItem> implements android.clustering.algo.Algorithm<T> {
    private final android.clustering.algo.Algorithm<T> mAlgorithm;
