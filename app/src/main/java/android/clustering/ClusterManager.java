...
import android.MarkerManager;
import android.clustering.Cluster;
import android.clustering.ClusterItem;
import android.clustering.algo.Algorithm;
import android.clustering.algo.NonHierarchicalDistanceBasedAlgorithm;
import android.clustering.algo.PreCachingAlgorithmDecorator;
import android.clustering.view.ClusterRenderer;
...
public class ClusterManager<T extends ClusterItem> implements
     ...
     */
    private class ClusterTask extends AsyncTask<Float, Void, Set<? extends android.clustering.Cluster<T>>> {
        @Override
        protected Set<? extends android.clustering.Cluster<T>> doInBackground(Float... zoom) {
        ...
        @Override
        protected void onPostExecute(Set<? extends android.clustering.Cluster<T>> clusters) {
    ...
    public interface OnClusterClickListener<T extends ClusterItem> {
        public boolean onClusterClick(android.clustering.Cluster<T> cluster);
    }
