...
package android.clustering.view;
...
import android.ui.SquareTextView;
...
import static android.clustering.algo.NonHierarchicalDistanceBasedAlgorithm.MAX_DISTANCE_AT_ZOOM;
...
public class DefaultClusterRenderer<T extends ClusterItem> implements ClusterRenderer<T> {
    ...
    private class RenderTask implements Runnable {
        ...
        @SuppressLint("NewApi")
        public void run() {
            if (clusters.equals(android.clustering.view.DefaultClusterRenderer.this.mClusters)) {
                mCallback.run();
                return;
            }
            ...
            if (android.clustering.view.DefaultClusterRenderer.this.mClusters != null && SHOULD_ANIMATE) {
                existingClustersOnScreen = new ArrayList<Point>();
                for (Cluster<T> c : android.clustering.view.DefaultClusterRenderer.this.mClusters) {
            ...
            mMarkers = newMarkers;
            android.clustering.view.DefaultClusterRenderer.this.mClusters = clusters;
            mZoom = zoom;
