...
import android.heatmaps.Gradient;
import android.heatmaps.WeightedLatLng;
import android.quadtree.PointQuadTree;
...
public class HeatmapTileProvider implements TileProvider {
     ...
     */
    public static final android.heatmaps.Gradient DEFAULT_GRADIENT = new android.heatmaps.Gradient(DEFAULT_GRADIENT_COLORS, DEFAULT_GRADIENT_START_POINTS);
     ...
     */
    private android.heatmaps.Gradient mGradient;
    ...
    public static class Builder {
        ...
        private android.heatmaps.Gradient gradient = DEFAULT_GRADIENT;
         ...
         * @return updated builder object
         */
        public Builder gradient(android.heatmaps.Gradient val) {
            gradient = val;
            return this;
        }
         ...
         */
        public android.heatmaps.HeatmapTileProvider build() {
            ...
            return new android.heatmaps.HeatmapTileProvider(this);
        }
    }
