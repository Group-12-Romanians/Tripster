...
public class VideoListViewAdapter extends BaseAdapter {
    ...
    public VideoListViewAdapter(tripster.tripster.newsFeed.video_player_manager.manager.VideoPlayerManager videoPlayerManager, Context context, List<BaseVideoItem> list){
